...
public class Main {
	 ...
	 * an entry of testLines (Guitar) ArrayList or drumTestLines (Drum) ArrayList.
	 * @param file is a string of the input file.
	 * @return an Array.
    ...
    /** 
   	 * This method reads each of the guitar notes from noteArray, collecting and storing their data.
   	 * @param noteArray is a ArrayList of type String.
   	 * @return an Array of a notes Part, Measure number, Element number, and Element value.
   	 */
    ...
    /** 
   	 * This method reads each of the drum notes from noteArray, collecting and storing their data.
   	 * @param noteArray is a ArrayList of type String.
   	 * @return an Array of a notes Part, Measure number, Element number, and Element value.
   	 */
    ...
    /** 
   	 * This converts the collect guitar tab data and converts it to an XML file format.
   	 * @param guitarNoteArray is a ArrayList of type String.
   	 * @return an XML file.
   	 */
    ...
    /** 
   	 * This converts the collect drum tab data and converts it to an XML file format.
   	 * @param drumNoteArray is a ArrayList of type String.
   	 * @return an XML file.
   	 */
    public static void drumXMLParser (ArrayList<DrumNote> drumNoteArray){
        //XML print attempt
        Directives directives = new Directives();
        directives
                .add("score-partwise")
